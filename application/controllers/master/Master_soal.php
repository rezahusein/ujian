...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Master_soal extends MY_Controller {
		...
		public function index()
		{
			...
			$this->template->load('template/template','master/master_soal/all-master_soal',$data);
		}

		public function create()
		{
			$data['page_name'] = "master_soal";
			$this->template->load('template/template','master/master_soal/add-master_soal',$data);
		}
...
$this->form_validation->set_rules('dt[urutan_soal]', '<strong>Urutan Soal</strong>', 'required');
		...
		public function edit($id)
		{
			...
			$this->template->load('template/template','master/master_soal/edit-master_soal',$data);
		}
