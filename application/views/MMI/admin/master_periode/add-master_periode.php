    ...
    <div class="card">
      ...
      <div class="card-body">
          <div class="show_error"></div><div class="form-group">
                ...
                <input type="text" class="form-control tgl" id="form-periode_dari" placeholder="Masukan Periode Dari" name="dt[periode_dari]" autocomplete="off">
            </div><div class="form-group">
                <label for="form-periode_sampai">Periode Sampai</label>
                <input type="text" class="form-control tgl" id="form-periode_sampai" placeholder="Masukan Periode Sampai" name="dt[periode_sampai]" autocomplete="off">
            </div><div class="form-group">
                ...
                <input type="text" class="form-control" id="form-persentase_pg" placeholder="Masukan Persentase Pg" name="dt[persentase_pg]" autocomplete="off">
            </div><div class="form-group">
                <label for="form-persentase_essay">Persentase Essay</label>
                <input type="text" class="form-control" id="form-persentase_essay" placeholder="Masukan Persentase Essay" name="dt[persentase_essay]" autocomplete="off">
            </div><div class="form-group">
