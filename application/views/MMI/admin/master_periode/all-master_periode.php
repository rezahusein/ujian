...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Soal Tes</h1> 
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Soal Tes</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">   
                                <div class="btn-create float-right">
                                    ...
                                    <i class="fas fa-plus"></i> Tambah Jadwal Tes
                                    </a>
                                </div>
                            </div>
                        </div>
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            var table = '<table class="table table-bordered table-hover table-striped d-table" id="mytable">'+
                   ...
                   '       <th style="width:5%" class="text-center">No</th>'+'<th>Periode</th>'+'<th>Durasi (Menit)</th>'+'<th>Persentase (Pilihan Ganda)</th>'+'<th>Persentase (Essay)</th>'+'<th>Standar Nilai</th>'+'       <th>Jumlah Soal</th>'+'       <th style="width:60px">Status</th>'+
