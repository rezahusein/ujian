...
<body style="background: #0066b238;">
    <div class="container">
        <nav>
            <div class="row" style="margin-top: 20px;">
                <div class="col-md-12">
                    <img src="<?= base_url() ?>assets-company-profile/images/logo-brand-mmi.svg" alt="" width="200">
                </div>
            </div>
        </nav>
        ...
        <!-- <div class="card card-custom">
            <div class="card-body">
                <div class="img-vector">
                    <img src="<?= base_url() ?>assets-company-profile/images/exam-success.png" alt="" width="300">
                </div>
                <h1 style="text-align: center;color:#0066b2;font-size:60px">Yeay ... </h1>
                <h2 style="font-weight: 100;text-align:center">Selamat anda di nyatakan <B style="color:#0066b2">LULUS</B> Test MicroMadaniInstitut</h2>
                <h2 style="font-weight: 100;text-align:center">Dengan predikat <b>score</b> anda : </h2>
                <p style="font-size: 60px;text-align:center;color:#058c05">
                    90
                </p>
            </div>
        </div> -->
    ...
    <!-- FAIL TEST -->
        ...
        <div class="card card-custom">
            <div class="card-body">
                <div class="img-vector">
                    <img src="<?= base_url() ?>assets-company-profile/images/fail.png" alt="" width="300">
                </div>
                <h1 style="text-align: center;color:#cc5333;font-size:60px">Oops :( ... </h1>
                <h2 style="font-weight: 100;text-align:center">Maaf anda di nyatakan <B style="color:#cc5333">TIDAK LULUS</B> Test MicroMadaniInstitut</h2>
                <h2 style="font-weight: 100;text-align:center">Dengan predikat <b>score</b> anda : </h2>
                <p style="font-size: 60px;text-align:center;color:#cc5333">
                    50
                </p>
            </div>
        </div>
           ...
           <div class="container" style="padding-bottom: 10px;">
                ...
                <div class="social-media" style="padding-bottom: px;display:flex;justify-content:center">
                    <ul>
                        ...
                        <li>
                            <a href=""><img src="<?= base_url() ?>assets-company-profile/images/social/youtube.svg" alt="" width="15"></a>
                        </li>
                        <li>
