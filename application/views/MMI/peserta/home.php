        ...
        <!-- <div class="info-box justify-content-center align-items-center" style="box-shadow:none">
            <div class="content-status">
                ...
                <div class="result-test text-center ">
                    <h1 style="font-size: 50px;" class="text-success">80</h1>
                </div>
            </div>
        </div>  -->
        ...
        <div class="info-box" style="box-shadow: none;">
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row mt-1">
                        <div class="col-12">
                            <span>Nama : Cahyo Fajar</span> 
                        </div>
                        <div class="col-12">
                            <span>Email : chyo@gmail.com </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-status">
                ...
                <!--
                    ...
                    4. Sedang ujian
                     ...
                     <span class="info-box-icon">
                         <i class="fas fa-clipboard-list text-primary" style="font-size: 55px;"></i>
                    </span> 
               ...
               <div class="play-test align-items-center d-flex text-center mt-3">
                   <!-- 
                       <h5>Sudah Mengerjakan Ujian.</h5>
                       <h5>Waktu Ujian Habis.</h5>
                       <h5>Tidak Lulus.</h5>
                       <h5>Sedang Mengerjakan Ujian.</h5>
                       <h5>Ujian Sedang Diproses.</h5>
                   -->
