 ...
 <!-- Content Wrapper. Contains page content -->
            ...
            <div class="box-header">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <a href="<?= base_url('master/Master_soal/create') ?>">
                    <button type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Master Soal</button> 
                  </a>
                  <a href="<?= base_url('fitur/ekspor/master_soal') ?>" target="_blank">
                    <button type="button" class="btn btn-sm btn-warning"><i class="fa fa-file-excel-o"></i> Ekspor Master Soal</button> 
                  </a>
                  <button type="button" class="btn btn-sm btn-info" onclick="$('#modal-impor').modal()"><i class="fa fa-file-excel-o"></i> Import Master Soal</button>
                  </div>
                </div>  
              </div>
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" master_soal="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
      <div class="modal-dialog modal-sm">
          <div class="modal-content">
              <form id="upload-delete" action="<?= base_url('master/Master_soal/delete') ?>">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
                    ...
                    { targets : [7],
                        render : function (data, type, row, meta) {
                              if(row['status']=='ENABLE'){
                                var htmls = '<a href="<?= base_url('master/Master_soal/status/') ?>'+row['id']+'/DISABLE">'+
                                            '    <button type="button" class="btn btn-sm btn-sm btn-success"><i class="fa fa-home"></i> ENABLE</button>'+
                                            '</a>';
                              }else{
                                var htmls = '<a href="<?= base_url('master/Master_soal/status/') ?>'+row['id']+'/ENABLE">'+
         ...
         function edit(id) {
            location.href = "<?= base_url('master/Master_soal/edit/') ?>"+id;
         }
